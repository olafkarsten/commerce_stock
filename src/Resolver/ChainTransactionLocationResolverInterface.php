...
interface ChainTransactionLocationResolverInterface extends TransactionLocationResolverInterface {
   ...
   * Adds a resolver.
   *
   * @param \Drupal\commerce_stock\Resolver\TransactionLocationResolverInterface $resolver
   *   The resolver.
   */
   ...
   *
   * @return \Drupal\commerce_stock\Resolver\TransactionLocationResolverInterface[]
   *   The resolvers.
   */
