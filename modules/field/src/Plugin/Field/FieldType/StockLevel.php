...
class StockLevel extends FieldItemBase {
  ...
  public function setValue($values, $notify = TRUE) {
    ...
    if (!empty($this->getEntity())) {
      ...
      $transaction_qty = $values['adjustment'] ?: 0;
  ...
  public function fieldSettingsForm(
    ...
    $form['required']['#description'] = $this->t('Stock levels fields must not marked as required. Learn more in the documentation.');
    $form['required']['#access'] = FALSE;
    return $form;
  }

  public function getFieldDefinition() {
    return parent::getFieldDefinition(); // TODO: Change the autogenerated stub
  }
