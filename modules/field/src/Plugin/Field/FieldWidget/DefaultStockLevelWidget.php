...
/**
 * Default implementation of the commerce stock level widget.
 *
 * @FieldWidget(
 *   id = "default_stock_level_widget",
 *   module = "commerce_stock_field",
 *   label = @Translation("Default stock level widget"),
 *   field_types = {
 *     "commerce_stock_level"
 *   }
 * )
 */
class DefaultStockLevelWidget extends WidgetBase {
  ...
  public function formElement(FieldItemListInterface $items, $delta, array $element, array &$form, FormStateInterface $form_state) {
    ...
    if ($entity->isNew()) {
      ...
      $element['value'] = $element + [
          ...
          '#description' => t('The initial stock level.'),
          '#step' => 1,
          ];
      return $element;
    }
